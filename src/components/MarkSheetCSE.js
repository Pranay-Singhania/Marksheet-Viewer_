      ...
      {ind?'':findname()} 
      {
        data && 
          <>
            ...
            <h5 style={{textAlign:'center', marginBottom:'30px'}}>B.Tech 1 Semester(CSE)</h5>
            <div>
            ...
            <div>
              ...
              {ind?
                ...
                <tr>
                  <td>{data[4][34]}</td>
                  <td className='text-center'>{data[6][34]}</td>
                  <td className='text-center'></td>
                  <td className='text-center'>{data[6][36]}</td>
                  <td className='text-center'>{data[ind][34]}</td>
                  <td className='text-center'>{data[ind][35]}</td>
                  <td className='text-center'>{data[ind][36]}</td>
                </tr>
